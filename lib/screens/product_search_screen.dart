                ...
                _results.isEmpty
                    ...
                    : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        debugPrint('🧪 Full search item: $item');
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    List<Basket> baskets =
                                        await ApiService.getBasketsByUser(
                                          userId,
                                        );

                                    // 👇 Auto-create "Basket 1" if no baskets exist
                                    if (baskets.isEmpty) {
                                      try {
                                        final newBasket =
                                            await ApiService.createBasket(
                                              userId: userId,
                                              name: "Basket 1",
                                            );
                                        baskets = [newBasket];
