...
import '../widgets/barcode_scanner_web.dart'; // adjust path if needed
...
class _ProductSearchScreenState extends State<ProductSearchScreen> {
  ...
  bool _loading = false;
  Timer? _debounce;
  Set<int> _expandedItems = {}; // 🧠 Tracks expanded item indexes
                ...
                onPressed: () async {
                  ...
                  if (baskets.isEmpty) {
                    try {
                      ...
                      debugPrint("❌ Basket creation failed: $e");
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("Failed to create basket"),
                        ),
                      );
                      return;
                    }
